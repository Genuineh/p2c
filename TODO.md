...
| Phase 1 | Week 2 | ✅ 已完成 | Flutter MVP | v1.0 |
...
- [x] 创建基础渲染器 (`src/codegen/base.ts`)
- [x] 实现 Flutter 渲染器 (`src/codegen/flutter.ts`)
  - [x] Container / Box 渲染
  - [x] Row / Column 布局
  - [x] Text 样式
  - [x] 圆角边框
  ...
  - [x] 渐变填充
  - [x] 图片处理
  - [x] Stack + Positioned 定位
- [x] 实现响应式布局支持
  - [x] MediaQuery 适配（通过 LayoutBuilder）
  - [x] FractionallySizedBox
  - [x] Flexible / Expanded
- [x] 代码格式化（dart format 风格）

### 验收标准
- [x] 复杂页面还原度 ≥90%
- [x] 生成代码可直接 `flutter run`
- [x] 支持至少 5 种常见布局模式
